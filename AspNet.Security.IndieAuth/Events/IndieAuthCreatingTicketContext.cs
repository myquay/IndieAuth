...
/// </summary>
public class IndieAuthCreatingTicketContext : ResultContext<IndieAuthOptions>
{
    /// <summary>
    /// Initializes a new <see cref="IndieAuthCreatingTicketContext"/>.
    /// </summary>
    ...
    public IndieAuthCreatingTicketContext(
        ClaimsPrincipal principal,
        AuthenticationProperties properties,
        HttpContext context,
        AuthenticationScheme scheme,
        IndieAuthOptions options,
        HttpClient backchannel,
        IndieAuthTokenResponse tokens,
        JsonElement user)
    ...
    /// </summary>
    public IndieAuthTokenResponse TokenResponse { get; }
    ...
    /// <summary>
    /// Gets the canonical user profile URL for the user this access token corresponds to.
    /// </summary>
    public string? Me => TokenResponse.Me;
    ...
    public TimeSpan? ExpiresIn
    {
        get
        {
            if (int.TryParse(TokenResponse.ExpiresIn, NumberStyles.Integer, CultureInfo.InvariantCulture, out int value))
